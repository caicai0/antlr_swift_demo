// Generated from ObjectiveCPreprocessorLexer.g4 by ANTLR 4.7.2
import Antlr4
...
open class ObjectiveCPreprocessorLexer: Lexer {
	...
	static let SHARP=1, CODE=2, IMPORT=3, INCLUDE=4, PRAGMA=5, DEFINE=6, DEFINED=7, 
            ...
            TRUE=15, FALSE=16, ERROR=17, BANG=18, LPAREN=19, RPAREN=20, 
            EQUAL=21, NOTEQUAL=22, AND=23, OR=24, LT=25, GT=26, LE=27, GE=28, 
            DIRECTIVE_WHITESPACES=29, DIRECTIVE_STRING=30, CONDITIONAL_SYMBOL=31, 
            DECIMAL_LITERAL=32, FLOAT=33, NEW_LINE=34, DIRECITVE_COMMENT=35, 
	...
	override open
	func getATN() -> ATN { return ObjectiveCPreprocessorLexer._ATN }
