...
public protocol ObjectiveCPreprocessorParserListener: ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code preprocessorCode}
	...
	/**
	 * Exit a parse tree produced by the {@code preprocessorCode}
	 * labeled alternative in {@link ObjectiveCPreprocessorParser#text}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by the {@code preprocessorDirective}
	 * labeled alternative in {@link ObjectiveCPreprocessorParser#text}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	...
	/**
	 * Exit a parse tree produced by the {@code preprocessorDirective}
	 * labeled alternative in {@link ObjectiveCPreprocessorParser#text}.
	 - Parameters:
	   - ctx: the parse tree
	 */
